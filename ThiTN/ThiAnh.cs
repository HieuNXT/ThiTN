...
namespace ThiTN
{
    public partial class ThiAnh : Form
    {
        ...
        void list()
        {
            SqlDataAdapter a = new SqlDataAdapter("Select qID, CauHoi, A, B, C, D, DapAn, pic from Question where Mon = 'Anh'", sql);
        ...
        private void ThiAnh_Load(object sender, EventArgs e)
        {
            list();
        }
